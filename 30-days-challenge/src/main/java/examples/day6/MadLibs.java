package examples.day6;

/*
       Example used in the tutorial: https://youtu.be/qsMfF0d5L20
 */
...
public class MadLibs {
    ...
    public void printInstructions(){
        System.out.println("Welcome to MadLibs game. If you type in words, we'll give you a story. " +
    ...
    public void putTogetherTheStory(){
        ...
        if (num == 0) {
            story = "Jesse and her best friend " + getName() + " went to Disney World today! " +
                    "They saw a " + getNoun1() + " in a show at the Magic Kingdom and ate a " + getAdjective1() +
                    " feast for dinner. The next day they ran " + getAdverb() + " to meet Mickey Mouse in his " + getNoun2() +
                    " and then that night they gazed at the " + getRandomNums() + " " + getAdjective2() +
            ...
            story = "Amanda and her frenemy " + getName() + " went to the zoo last summer. " +
                    ...
                    " to get a closer look. The zoo was " + getAdjective1() + " at night, but they did not care ... until " +
                    getRandomNums() + " " + getAdjective2() + " apes yelled in their faces, making Amanda and " + getName() +
